...
export default function TicketList() {
  ...
  return (
    <div style={{ width: '100%', height: '100vh' }}>
      ...
      <div
        style={{ width: '100%', alignItems: 'center', position: hamburgerClick ? 'fixed' : 'absolute', height: '100%' }}
      >
        <main
          style={{
            margin: 0,
        ...
        >
          <div
            style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', maxWidth: '1500px', width: '100%' }}
          >
            <Ticket />
          </div>
        </main>
