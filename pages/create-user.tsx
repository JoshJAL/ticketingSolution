            ...
            {submitted ? (
              <>
                ...
                <button
                  ...
                  style={{ fontSize: 21, padding: '5px 10px', cursor: 'pointer' }}
                >
                  Create another?
                </button>
              </>
              ...
              <>
                ...
                <button
                  style={{ margin: '20px 0 10px 0', padding: '10px 20px' }}
                  onClick={(e) => {
                    e.preventDefault();
                    !selection ? {} : createUser(e);
                  }}
                >
                  {!selection ? 'Please select a user type' : creating ? 'Creating user...' : 'Create user'}
                </button>
              </>
            )}
          </form>
